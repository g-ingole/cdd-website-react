        ...
        <div>
            <div className='row'>
                ...
                <div className='row'>
                    ...
                    <div className='col-lg-6 mt5' style={{ paddingLeft: "160px" }}>
                        <h1 className='ffx b pt5' style={{ fontSize: "60px" }}>The Best Bite in<br />
                            the Neighborhood</h1>
                        ...
                        <button className='bta mt5'><a href='/menu' style={{ textDecoration: "none", color: "#000000" }}>View Menu</a></button>
                    </div>
                </div>
            </div>
            <div className='row'>
                <div className='col-lg-12 tc' style={{ backgroundColor: "#60695d" }}>
                    <h1 className='pt3' style={{ fontSize: "35px", fontFamily: "heebo-light, sanf-serif", color: "#fff" }}>Real Food. No Secret Ingredients.</h1>
                </div>
                <div className='row'>
                    <div className='col-lg-6 mt5' style={{ paddingLeft: "180px" }}>
                        ...
                        <p style={{ fontSize: "20px", fontFamily: "heebo-light, sanf-serif" }}>I'm an extra long title. Click here to add your own text and edit <br />
                            ...
                            own content and make changes to the font. I’m a great place for<br />
                            you to tell a story and let your users know a little more about you.</p>
                        <button className='bt mt3'><a href='/contact' style={{ textDecoration: "none", color: "#000000" }}>Visit Us</a></button>

                    </div>
                    <div className='col-lg-6' >
                        <img src={img11} alt='' width={800} height={900} style={{ marginLeft: "25px" }} />
                    </div>
                </div>
