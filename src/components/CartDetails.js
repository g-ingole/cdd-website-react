                                    ...
                                    return (
                                        <div className='d-flex shadow-1 p-5' >
                                            <div className='items_img '>
                                                <img alt='' src={ele.imgdata} width={400} height={300} />
                                            </div>
                                            <div className='details ml5'>
                                                <h1>Name: <strong>{ele.rname}</strong></h1>
                                                <h1>Price: <strong>{ele.price}</strong></h1>
                                                <h1>Total: <strong>{ele.price * ele.qnty}$</strong></h1>
